...
<p align="justify">
    Welcome to the <b>Date/Time API</b> repository! This repository provides hands-on demos explaining the limitations
    of legacy <b>Date</b> and <b>Calendar</b> classes and how the modern <b>java.time</b> package offers improved
    solutions. It covers various <b>Date</b> and <b>Time</b> classes, formatting techniques, and duration calculations
    to handle date-time operations effectively.
</p>
...
<ol align="left">
    <li>Problems with Date</li>
    <li>Problems with Calendar</li>
    <li>Understanding LocalDate</li>
    <li>Understanding LocalTime</li>
    <li>Understanding LocalDateTime</li>
    <li>Understanding OffsetDateTime</li>
    <li>Understanding ZonedDateTime</li>
    <li>Understanding ChronoUnit, Period and Duration</li>
    <li>Understanding DateTimeFormatter</li>
</ol>
...
<ul>
    ...
    <li><a href="https://youtu.be/_IqRZbFjZcc"
...
<p align="justify">
    ...
    Watch the complete video here: <a href="https://www.youtube.com/watch?v=boWL7j-Fk1U"
        target="_blank"><b>Date/Time API</b></a>.
</p>
